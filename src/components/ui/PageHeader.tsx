  ...
  return (
    <section className="relative h-64 md:h-96 overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 pt-16">
        {titleIt ? (
          <p className="font-heading text-gold-light tracking-[0.2em] text-sm md:text-base mb-1">
            {titleIt}
          </p>
        ) : null}
        {titleReading && (
          <p className="font-heading-jp text-cream/80 text-xs md:text-sm tracking-[0.15em] mb-1">
            {titleReading}
          </p>
        )}
